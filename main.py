...
from doc_renderer import build_doc_embed  # Наш новый необрезанный модуль
...
# НАСТРОЕННЫЙ СЛЭШ-ПОКАЗ ДОКУМЕНТОВ С КРАСИВЫМ ВЫБОРОМ (CHOICES)
...
@bot.event
async def on_ready(): print(f"🤖 Чистая модульная архитектура запущена! Команда /показать полностью исправлена.")
